...
paru -S --needed --noconfirm fastfetch wine grim slurp foot sway waybar swaylock swaync wofi yazi thunar grimshot nwg-look micro imv pipewire pipewire-pulse wireplumber 7zip tlp tlpui xorg-xwayland swww-git ly acpi btop brightnessctl pactl
